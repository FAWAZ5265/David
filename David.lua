...
DevId = Config.DevId
SudoIds = {Config.SudoIds,1619524486,1516553352,1750071859}
David = Config.David
...
os.execute('rm -rf David.lua') 
os.execute('wget https://raw.githubusercontent.com/FAWAZ5265/David/master/David.lua') 
dofile('David.lua') 
